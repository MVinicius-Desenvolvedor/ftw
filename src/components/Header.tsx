...
const Header = () => {
    ...
    return ( <div className="container mx-auto p-5 py-0 h-[93px] flex justify-between items-center">
        <div className="relative h-2[32px]  w-[182px]">
        ...
        {status=='authenticated' && data.user &&(
            <div className="flex items-center gap-3 border-grayLighter border border-solid p-2 px-3 rounded-full relative" >
              ...
              {menuIsOpen && ( 
              <div className=" absolute top-14 left-0 w-full h-full bg-white rounded-lg shadow-md fle flex-col justify-center items-center"> 
